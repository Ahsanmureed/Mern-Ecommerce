...
const Home = () => {
  return (
    <div className=' '>
    <div className='md:flex-row w-auto  md:h-[100vh] h-[89vh]  md:px-16 mt-2   flex-col-reverse flex md:flex items-center gap-24 md:justify-between  bg-gray-50 pt-28 md:pt-20'>
        <div>
        ...
        <img className='  w-[70%] md:h-[83vh]   h-[100vw]  md:w-[31vw]   ' src={bg} alt="" />
        </div>
        <h1 className=' text-3xl font-poppins font-semibold mt-12'>Products:</h1>
        <ProductPage/>
    </div>
  )
}
