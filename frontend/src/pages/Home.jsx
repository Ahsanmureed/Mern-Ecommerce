...
const Home = () => {
  return (
    ...
    <div className='md:flex-row w-auto h-[75vh]  md:h-[100vh]  hello  md:px-16    flex-col-reverse flex md:flex items-center gap-24 md:justify-between  bg-gray-50  md:pt-20'>
        <div>
        ...
        <img className='  w-[70%] md:h-[86vh]   h-[100vw]  md:w-[31vw]   ' src={bg} alt="" />
        </div>
